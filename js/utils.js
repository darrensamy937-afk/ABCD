...
async function importAllData(file) {
    ...
    try {
        ...
        const categories = [
            ...
            {
                id: 'replies',
                label: '回复 / 拍一拍 / 氛围（含摸鱼字卡）',
                indexedDBNeedles: ['customReplies', 'customPokes', 'customStatuses', 'customMottos', 'customIntros', 'customEmojis', 'customReplyGroups', 'customPokeGroups', 'customStatusGroups', 'kaomojiLibrary', 'kaomojiGroups'],
                localStorageNeedles: ['disabledReplyItems', 'pokeSym_my', 'pokeSym_partner', 'pokeSym_my_custom', 'pokeSym_partner_custom', 'punctuation_library_v1', 'punctuation_settings_v1']
            },
            {
                id: 'moyu',
                label: '摸鱼小记（记录 / 地点 / 活动）',
                indexedDBNeedles: ['moyuRecords', 'moyuLocations', 'moyuActivities', 'currentMoyuRecord', 'moyuUnread', 'moyuWorkSession'],
                localStorageNeedles: []
            },
            {
                id: 'moments',
                label: '朋友圈（动态 / 好友 / 访客）',
                indexedDBNeedles: ['moments_data'],
                localStoragePrefixes: ['moments_']
            },
            {
                id: 'stickers',
                label: '表情库（贴纸）',
            ...
            },
            {
                id: 'themes',
                label: '主题 / 外观 / 图库',
                indexedDBNeedles: ['customThemes', 'themeSchemes', 'backgroundGallery', 'chatBackground', 'partnerAvatar', 'myAvatar', 'partnerPersonas', 'playerCover'],
                localStorageNeedles: []
            },
            {
                id: 'dg',
            ...
            },
            {
                id: 'shop',
                label: '商城（余额 / 礼品柜）',
                indexedDBNeedles: ['shop_balance', 'shop_searchHistory', 'shop_giftCabinet'],
                localStorageNeedles: []
            },
            {
                id: 'taPhone',
                label: 'TA的手机（收藏夹）',
                indexedDBNeedles: ['ta_phone_collections'],
                localStorageNeedles: []
            },
            {
                id: 'pet',
            ...
            },
            {
                id: 'avatarSwap',
                label: '头像交换库',
                indexedDBNeedles: ['avatar_swap_data'],
                localStorageNeedles: []
            },
            {
                id: 'foodMenu',
                label: '吃什么（菜谱）',
                indexedDBNeedles: [],
                localStorageNeedles: ['food_menu_settings_v1']
            },
            {
                id: 'dnd',
                label: '免打扰设置',
                indexedDBNeedles: [],
                localStorageNeedles: ['dnd_settings', 'partner_dnd_state', 'partnerDNDChance']
            },
            {
                id: 'mapDetect',
                label: '地图检测',
                indexedDBNeedles: [],
                localStorageNeedles: ['map_detect_settings_v1']
            },
            {
                id: 'healthDetect',
                label: '健康检测',
                indexedDBNeedles: [],
                localStorageNeedles: ['health_detect_settings_v1']
            }
        ];
        ...
        // 导入后重新加载标点符号库
        try {
            if (window.PunctuationLib && typeof window.PunctuationLib.reload === 'function') {
                window.PunctuationLib.reload();
            }
        } catch(e) {}
